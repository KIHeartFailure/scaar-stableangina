...
KOLLA IGENOM KODER NOGGRANT. OBSERVERA ATT ALLA ICD DU SPECADE INTE FINNS MED DÅ INTE ÄR BESTÄLLDA ENLIGT SOS SPECEN (SE TIDIGARE SKICKAT DOKUMENT) SÅ DU MÅSTE GÅ IGENOM OCH KONTROLLERA DETTA. 

HAR ÄVEN LAGT TILL NÅGRA COMORB. SE OM OK. 

Names for case (stable angina???)/control??? For tables/figs.

ÅTERKOM MED LÄMPLIGA (ENGELSKA OCH KORTA) NAMN PÅ MEDICINERNA

Kolla även om variablerna som ska inkluderas i modellerna stämmer med vad du tänkte. 
...
Note to self: Ändra detta till stand diff?
...
Further, as a consistency analysis, Blodfettsänkande/Trombocythämmare/antikoagulantia (Strokeprevention), bbl, rasi/arni,  ccb, P2Y12i/asa, noak/waran, antidiabetic were modelled as time-dependepent covariates in the model. 
...
JAG ÄR LITE OSÄKER PÅ modellern med För stenosgrad 0-29 vs 30-49%. Det blir lite knasigt för utfallet kommer ju då att ha skett INNAN flera av variablerna (då index är + 14 dagar efter intervention).  

### Association between outcomes and age for cases

{{< include src/agespline.qmd >}}
