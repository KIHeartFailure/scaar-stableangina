...
Subgroup analyses were also performed for the fully adjusted model by lipid lowering medication, glucose lowering medication and number of risk factors. The risk factors considered were hypertension, glucose lowering medication, lipid lowering medication and COPD. In the risk factor subgroup analyses the individual risk factor components were not included in the model. 
...
residuals leading to that cancer was stratified for in the model with outcome Death. Further, ANOCA/Comparator showed non-proportional hazards in the model with outcome Repeated diagnostic coronary angiography and therefore the results for this model should be interpreted with care. Similar with Year in the model with outcome revascularization for the ANOCA cases only. 
...
{{< include src/outcomes_forest.qmd >}}
