...
outcomesfunc_inner <- function(data, time, event, eventname, xvar = "case",
  ...
  ## 6 row - adjusted regression
  out[6, 2] <- "Adjusted (age, sex, region, comorbidities (excl. stroke, HF, CKD, AF), medications, socioeconomics) Hazard Ratio (95% CI), p-value"
  ex <- str_detect(coxvars, c("sos_com_hf|sos_com_stroke|sos_com_ckd|sos_com_af"), negate = T)
  tmpcoxvars <- coxvars[ex]
  ...
  ## 7 row - adjusted regression w timedependent meds
  out[7, 2] <- "Adjusted (age, sex, region, comorbidities, medications, socioeconomics with timedependent medications) Hazard Ratio (95% CI), p-value"
  mod <- summary(coxph(
    formula(paste0(
  ...
  if (fg) {
    out[8, 2] <- "Adjusted (age, sex, region) Sub-distributional Hazard Ratio (95% CI), p-value"
    ...
    out[9, 2] <- "Adjusted (age, sex, region, comorbidities, medications, socioeconomics) Sub-distributional Hazard Ratio (95% CI), p-value"
    mod <- summary(coxph(
      formula(paste0(
