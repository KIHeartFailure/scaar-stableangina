...
outcomesfunc <- function(var, val, novar = NULL, fgall = F) {
  ...
  out9 <- outcomesfunc_inner(
    data = data,
    time = "scaar_outtime_cacheck",
    event = "scaar_out_cacheck",
    eventname = "Check CA without -/missing",
    novar = novar,
    fg = F,
    timedata = timedata_ca
  )
  outall <- rbind(out1, out2, out3, out4, out5, out6, out7, out8, out9)
