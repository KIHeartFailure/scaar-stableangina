  ...
  out <- left_join(out,
    ...
    mutate(
      ...
      var = case_when(
        ...
        var == "scb_age_cat55-64" ~ "Age (years) 55-64 vs <55",
        var == "scb_age_cat65-80" ~ "Age (years) 65-80 vs <55",
        var == "scb_age_cat>80" ~ "Age (years) >80 vs <55",
