...
vars <- vars %>%
  mutate(
    ...
    data5 = if_else(str_detect(var, "scb_child|cb_maritalstatus|scb_age|scb_sex"), "RTP", NA),
    data6 = if_else(str_detect(var, "scaar_"), "SCAAR", NA),
...
default_kable(vars,
  ...
  footnote(
    ...
    general_title = "",
    general = c(
      "Abbreviations: NPR, The National Patient Register; NPDR, The National Prescribed Drug Register; LISA, Longitudinal integrated database for health insurance and labour market studies; RTP, Register of the Total Population"
    ),
